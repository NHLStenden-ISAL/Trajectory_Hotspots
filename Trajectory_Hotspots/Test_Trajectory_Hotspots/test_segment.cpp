...
namespace TestTrajectoryHotspots
{
    ...
    public:
        ...
        TEST_METHOD(orientation_left_right_free_function)
        {
            ...
            Assert::IsFalse(orientation_top_left(segment.start, segment.end));
            Assert::IsTrue(orientation_top_left(segment.end, segment.start));

            Segment vertical_segment(Vec2(34.f, 12.f), Vec2(34.f, 1.f));

            Assert::IsFalse(orientation_top_left(vertical_segment.start, vertical_segment.end));
            Assert::IsTrue(orientation_top_left(vertical_segment.end, vertical_segment.start));

            Segment horizontal_segment(Vec2(-2.f, -10.f), Vec2(5.f, -10.f));

            Assert::IsFalse(orientation_top_left(horizontal_segment.start, horizontal_segment.end));
            Assert::IsTrue(orientation_top_left(horizontal_segment.end, horizontal_segment.start));
